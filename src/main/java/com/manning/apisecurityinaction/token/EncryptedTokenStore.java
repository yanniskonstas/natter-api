...
public class EncryptedTokenStore implements SecureTokenStore {
    ...
    public String create(Request request, Token token) {
        ...
        var nonceAndCiphertext = encrypt(encryptionKey, decoder.decode(tokenId));
 
        return encoder.encodeToString(nonceAndCiphertext[0]) + '.' + encoder.encodeToString(nonceAndCiphertext[1]);
    }
